...
const MintNft = () => {
  ...
  const [errorStage, setErrorStage] = useState<number>(-1);
  ...
  useEffect(() => {
    ...
    uploadToInfura(makeblob(baseImageUrl));
    setFetch(false);
  }, [baseImageUrl]);
    ...
    <div className="flex  min-h-screen w-full text-white justify-center items-center">
      <div className=" space-y-4 p-10 bg-gray rounded-lg">
        ...
        <div className=" gap-3 justify-center items-center w-full sm:flex-col flex pt-5">
          ...
          <a
            href={baseImageUrl}
            download={downloadLink ? downloadLink : fileUrl}
          >
            <Button
      ...
      <div>
        ...
        {mintStage === 2 ? (
          ...
          <div className="flex w-full sm:flex-col mt-10 sm:mt-5 sm:pl-5 sm:pr-5 pl-20 pr-20 pb-10 justify-between">
            ...
            <div className="w-[500px] text-white md:ml-10 sm:ml-0 sm:w-full">
              <Input
                inputType="input"
                textColor="text-white"
                bgColor="bg-nft-black-1"
                title="Name"
